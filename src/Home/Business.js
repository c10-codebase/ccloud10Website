                ...
                <div className="h-100 container">
                    <div className="row h-100 align-items-center">
                        <div className="col-md-12">
                            ...
                            <br/>
                            <h1 className="d-inline-block wow fade-in-bottom re-work">BUSINESS INTELLIGENCE</h1>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div>
            <div className="subServiceContent sect-2">
                <div className="subServiceContentHeader container">
                    ...
                    <h4>Accelerate decision-making and optimize internal business process for faster data driven decisions. We create an interactive way to interpret data,
                         identify new opportunities and share data driven insights in a closely guarded environment.</h4>
                </div>
                                        ...
                                        <div className="row no-gutters">
                                            <div className="col-md-8">
                                                <div className="uiSubContentCardBody">
                                                    <div className="uiSubContentCardTitle-5">Design Models</div>
                                                    <div className="uiSubContentCardText uiSubContentCardCapyion">
                                                        <p>Design, develop and create multidimensional databases that integrates competing methodologies.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="uiSubContentImg">
                                                    <img src={images.dtcontentimg22} alt="contentimage" ></img>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-md-12">
                                    <div className="uiSubContentCard">
                                        <div className="row no-gutters">
                                            <div className="col-md-8">
                                                <div className="uiSubContentCardBody">
                                                    <div className="uiSubContentCardTitle-5">Data Exploration And Visualization</div>
                                                    <div className="uiSubContentCardText uiSubContentCardCapyion">
                                                        <p>Discover new patterns, identify key relations and visually explore relevant data backed by analytics.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                ...
                                <div className="col-md-12">
                                    <div className="uiSubContentCard">
                                        <div className="row no-gutters">
                                            <div className="col-md-8">
                                                <div className="uiSubContentCardBody">
                                                    <div className="uiSubContentCardTitle-5">Analyze</div>
                                                    <div className="uiSubContentCardText uiSubContentCardCapyion">
                                                        <p>Accelerate decision-making and optimize internal business process based on analysis of insights.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="uiSubContentImg">
                                                    <img src={images.dtcontentimg29} alt="contentimage" ></img>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
