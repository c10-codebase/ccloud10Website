                ...
                <div className="h-100 container">
                    <div className="row h-100 align-items-center">
                        <div className="col-md-12">
                            ...
                            <br/>
                            <h1 className="d-inline-block wow fade-in-bottom re-work">CONTENT MANAGEMENT SYSTEMS</h1>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div>
            <div className="subServiceContent sect-2">
                <div className="subServiceContentHeader container">
                    <h2>Flexible Websites</h2>
                    <h4>Our cms web development services provide omnichannel digital environment that manages content assets with ease. 
                        Personalized, tailored, and flexible solutions to content management systems.</h4>
                </div>
                                        ...
                                        <div className="row no-gutters">
                                            <div className="col-md-8">
                                                <div className="uiSubContentCardBody">
                                                    <div className="uiSubContentCardTitle-3">Search Engine Optimized Websites</div>
                                                    <div className="uiSubContentCardText uiSubContentCardCapyion">
                                                        <p>Allows easy and regular content updation that optimizes and enhances visibility of websites.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="uiSubContentImg">
                                                    <img src={images.dtcontentimg42} alt="contentimage" ></img>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-md-12">
                                    <div className="uiSubContentCard">
                                        <div className="row no-gutters">
                                            <div className="col-md-8">
                                                <div className="uiSubContentCardBody">
                                                    <div className="uiSubContentCardTitle-3">Customization</div>
                                                    <div className="uiSubContentCardText uiSubContentCardCapyion">
                                                        <p>Easy development, personalization and implementation using industry leading technologies like WordPress, Drupal, Joomla and ExpressionEngine.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                ...
                                <div className="col-md-12">
                                    <div className="uiSubContentCard">
                                        <div className="row no-gutters">
                                            <div className="col-md-8">
                                                <div className="uiSubContentCardBody">
                                                    <div className="uiSubContentCardTitle-3">Design Flexibility</div>
                                                    <div className="uiSubContentCardText uiSubContentCardCapyion">
                                                        <p>Lucid design adaptability with brand style and colour for easy refinement and visual consistency.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="uiSubContentImg">
                                                    <img src={images.dtcontentimg44} alt="contentimage" ></img>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
