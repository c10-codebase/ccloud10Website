                ...
                <div className="h-100 container">
                    <div className="row h-100 align-items-center">
                        <div className="col-md-12">
                            ...
                            <br/>
                            <h1 className="d-inline-block wow fade-in-bottom re-work">POINT OF SALE</h1>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div>
            <div className="subServiceContent sect-2">
                <div className="subServiceContentHeader container">
                    <h2>Digital Systems Of Operations</h2>
                    <h4>A true differentiator for business that customizes and tracks operations efficiently and effectively. We deliver end to end, integrated solutions that 
                        streamlines business system and expedites decision-making processes with improved security measures.</h4>
                </div>
                                        ...
                                        <div className="row no-gutters">
                                            <div className="col-md-8">
                                                <div className="uiSubContentCardBody">
                                                    <div className="uiSubContentCardTitle-5">Automatic</div>
                                                    <div className="uiSubContentCardText uiSubContentCardCapyion">
                                                        <p>Manage and analyze inventory by automating the process and providing real time alerts.</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="col-md-12">
                                    <div className="uiSubContentCard">
                                        <div className="row no-gutters">
                                            <div className="col-md-8">
                                                <div className="uiSubContentCardBody">
                                                    <div className="uiSubContentCardTitle-5">Analytics</div>
                                                    <div className="uiSubContentCardText uiSubContentCardCapyion">
                                                        <p>Analyze as well as keep track of operations efficiently and effectively.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="uiSubContentImg">
                                                    <img src={images.dtcontentimg53} alt="contentimage" ></img>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-md-12">
                                    <div className="uiSubContentCard">
                                        <div className="row no-gutters">
                                            <div className="col-md-8">
                                                <div className="uiSubContentCardBody">
                                                    <div className="uiSubContentCardTitle-5">Digital</div>
                                                    <div className="uiSubContentCardText uiSubContentCardCapyion">
                                                        <p>Calculate and display data digitally eliminating the need to maintain data in a traditional fashion.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="uiSubContentImg">
                                                    <img src={images.dtcontentimg54} alt="contentimage" ></img>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
